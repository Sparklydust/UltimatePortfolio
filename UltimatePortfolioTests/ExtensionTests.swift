...
//
//  Created by Roland Lariotte on 02/03/2021.
//
...
class ExtensionTests: XCTestCase {
  ...
  func testSequenceKeyPathSortingCustom() {
    ...
    XCTAssertEqual(sortedItems, [example3, example2, example1], "Reverse shorting should yield c.")
  }
  ...
  func testDecodingString() {
    ...
    XCTAssertEqual(
      data,
      "Then rain in Spain falls mainly on the Spaniards." ,
